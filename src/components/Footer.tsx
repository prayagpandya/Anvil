...
export default function Footer() {
  return (
    <footer className="relative bg-[#050505] border-t border-[#D91E26]/20 overflow-hidden">
      <div className="absolute inset-0 grid-bg opacity-30" />
      <div className="absolute top-0 left-0 right-0 h-[2px] diag-stripes opacity-50" />
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 pt-20 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <div className="flex items-center gap-3">
              {[Rss, Share2, MessageSquare, Send].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 border border-white/10 flex items-center justify-center hover:border-[#D91E26] hover:text-[#D91E26] transition-colors">
                  <Icon size={16} />
                </a>
              ))}
            </div>
          ...
          <div>
            <h4 className="font-display text-lg tracking-widest text-white mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <ul className="space-y-3 text-neutral-400 text-sm">
              {[
                ...
                <li key={c} className="flex items-center gap-2 hover:text-white transition-colors">
            ...
            <ul className="space-y-4 text-neutral-400 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <a href="tel:+919998022557" className="hover:text-white">+91 99980 22557</a>
                  <a href="tel:+919725488881" className="hover:text-white">+91 97254 88881</a>
                </div>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={16} className="text-[#D91E26] shrink-0" />
                <a href="mailto:anviltechnoforge@gmail.com" className="hover:text-white break-all">anviltechnoforge@gmail.com</a>
              </li>
              <li className="flex items-center gap-3">
                <Globe size={16} className="text-[#D91E26] shrink-0" />
                <a href="https://www.anviltechnoforge.co.in" className="hover:text-white">www.anviltechnoforge.co.in</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 mb-8">
          <div className="font-bebas text-[18vw] lg:text-[12vw] leading-none text-white/[0.04] tracking-[0.02em] select-none">
            ANVIL TECHNO FORGE
          </div>
        </div>

        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-neutral-500 border-t border-white/10 pt-6">
