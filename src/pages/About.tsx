      ...
      <section className="relative py-24 bg-black">
        <div className="max-w-[1400px] mx-auto px-6 grid md:grid-cols-2 gap-6">
          {[
            ...
            >
              <div className="absolute -top-6 -right-6 w-32 h-32 diag-stripes opacity-40" />
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <Link to="/infrastructure" className="btn-primary">Explore Infrastructure <ArrowRight size={14} /></Link>
