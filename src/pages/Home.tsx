              ...
              i === current && (
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link to="/products" className="btn-primary shine">Explore Products <ArrowRight size={16} /></Link>
                    <Link to="/infrastructure" className="btn-outline">Our Infrastructure <Play size={14} /></Link>
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-4">
            ...
            />
            <Link to="/about" className="inline-flex items-center gap-2 mt-8 text-[#D91E26] hover:gap-4 transition-all font-display tracking-widest text-sm">
          ...
          <div className="mt-12 flex flex-wrap gap-2 border-b border-white/10 pb-4">
            {Object.keys(materials).map((m) => (
              <button
                ...
                className={`px-6 py-3 font-display tracking-widest text-sm transition-all relative ${
                  activeMat === m ? "text-[#D91E26]" : "text-neutral-400 hover:text-white"
                }`}
              >
                {m.toUpperCase()}
                {activeMat === m && (
      ...
      <section className="relative py-24 lg:py-32 bg-black">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8">
            ...
            />
            <Link to="/infrastructure" className="inline-flex items-center gap-2 text-[#D91E26] font-display tracking-widest text-sm hover:gap-4 transition-all">
      ...
      <section className="relative py-24 bg-[#D91E26] overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-black text-white font-display tracking-widest text-sm hover:bg-white hover:text-black transition-all">
